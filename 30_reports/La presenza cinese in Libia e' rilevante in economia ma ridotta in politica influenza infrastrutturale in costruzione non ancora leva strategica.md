...
base) che segnalerebbe un impegno strategico. Ne deriva un'influenza **economico-infrastrutturale in
...
## 1 · La presenza: cosa fa la Cina in Libia

**Diplomazia.** L'ambasciata cinese a Tripoli, chiusa dal 2014, ha **riaperto a novembre 2025**; l'ambasciatore
Ma Xueyong tiene una cadenza sistematica di incontri col GNU (infrastrutture, ricostruzione, energia, sanità,
istruzione) e con l'Interno (formazione, comunicazioni, sicurezza) — un ritmo insolito per una missione appena
...
caccia J-16; la Libia — frammentata e senza un chokepoint — offre invece una **"prova a basso costo"** della
stessa logica (capitale, infrastrutture, finanza senza vincoli d'alleanza) su uno Stato troppo debole per
contrattare. `[Decode39 — B2]` L'influenza cinese è quindi **reale ma tenue**, e soprattutto **reversibile**:
poggia su convenienza economica, non su dipendenza strutturale o presenza di sicurezza.

## 3 · Evoluzione — breve termine (~1 anno, a set 2027) `[MEDIUM-LOW confidence]`
Approfondimento **incrementale e a basso impegno**: operatività del canale CIPS, forum energetico di Misurata
(nov 2026), nuovi MoU di ricostruzione, cadenza diplomatica costante. Nessun gesto strategico (porto/base)
atteso. `[Decode39 — B2]` **Variabile decisiva: la stabilità libica** — se prevale lo scenario di *rottura*
(crisi CBL o guerra tra milizie, cfr. il report sulla pace), Pechino **congela e attende**, com'è nel suo
metodo avverso al rischio; la riapertura stessa dell'ambasciata fu subordinata al giudizio che una presenza
...
Per Roma la Cina in Libia **non è (ancora) un rivale frontale** ma un concorrente che *compone influenza per
infrastrutture, non per confronto*: come in [[Egitto]], il compito italiano è "restare la più difficile da
rimpiazzare", presidiando gli asset dove è già dentro — [[Eni]], energia, ricostruzione (cfr. [[Italia]]). `[Decode39 — B2]`
Il rischio non è l'espulsione, ma la **diluizione graduale** della centralità italiana se Pechino occupa spazi
di ricostruzione e finanza lasciati scoperti.

## Indicatori di verifica (prossimi 6-18 mesi)
- **CIPS**: il collegamento bancario diventa operativo con volumi reali, o resta annuncio? `[test di sostanza finanziaria]`
- **Forum di Misurata (nov 2026)**: produce contratti energetici firmati o solo cornici? `[test commerciale]`
- **Asset/embargo**: la Cina continua a rifiutare le richieste di Tripoli (neutralità), o cede su qualcosa? `[test di svolta politica]`
...
(ChinaMed, Decode39, Atlantic Council, Africa Intelligence); **B3** flagship/stampa regionale (Libya Herald/Observer, MEMO) e fonte statale
interessata (gov.cn) o di parte (LANA), flagship press e ripresa tradotta (BBC Monitoring, SCMP); **C3** outlet locale. Le bande del §4 sono stime ancorate al quadro
