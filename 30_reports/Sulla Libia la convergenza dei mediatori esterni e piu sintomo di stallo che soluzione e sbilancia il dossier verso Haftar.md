...
**congelamento** — la diluizione prevale **nel breve** perché **tre forze concordi** (il 90% pro-voto, la road map ONU, le
...
- **Nota di coerenza (col report sulla pace)**: qui "diluizione prevale" descrive la **traiettoria della mediazione nel breve**; sull'orizzonte dei **24 mesi** quella traiettoria ha ~45-55% di **arenarsi in congelamento** (l'esito prevalente di quel report) — *processo* vs *esito*, non ranking in conflitto.
...
- **Verdetto**: *convergenza = stallo* e *diluizione > spartizione* **reggono**.
...
che il **90% dei libici** vuole elezioni nazionali, e la road map dei tre vertici (HoR, Consiglio di Stato,
...
## Cosa osservare (indicatori di verifica)
...
- La road map verso il **voto** avanza in parallelo, o viene assorbita dal power-sharing? `[test di legittimità — il metro del 90%]` — *agg. **30 ago**: il 4+4 (GNU/HCS/HoR/LNA) **firma un accordo** all'UNSMIL e **Boulos/USA vi convergono** — ma il target slitta da feb 2027 a "**24 mesi**". È lo scenario di **diluizione verso le urne** (con timeline estesa) previsto come più probabile, non l'assorbimento nel power-sharing: **la previsione regge**.*
