...
revisione: "2 — post-adversary (_critique/Italia-due-tavoli-Mediterraneo-orientale__critique.md, voto v1 5/10)"
fonti_note: ["EastMed", "Dispute zee", "Turchia", "Blue homeland", "Cipro", "Grecia", "Egeo", "Eni", "Mediazione statunitense"]
...
- **Tavolo energetico:** [[Eni]] è il **primo operatore offshore a [[Cipro]]** (7 dei 13 blocchi; campi
  Cronos/Zeus). Posizione decisiva **come operatore** (non come *hub*: il gas cipriota è esportato in UE **via Egitto**, non transita dall'Italia). `[HIGH confidence · fonti: Washington Institute — B2, CSIS — B2]`
...
Essere decisivi su due tavoli non è "decisiva in nessuno": è il contrario.

## I due dossier non sono lo stesso gioco
Energia (blocchi ciprioti, contratti Eni) e stabilizzazione libica (controllo della costa, migrazione) hanno
attori, tempi e logiche **diversi**. Definirli "opposti" presuppone che debbano essere coerenti; ma molti Stati
— inclusa la Turchia stessa — mantengono posizioni differenziate per dossier senza pagarne "peso diluito".
Il MoU marittimo turco-libico del 2019 ([[Blue homeland]]) è ciò che l'EMGF osteggia, ma **cooperare su Tripoli
con Ankara non equivale ad avallare quel MoU**: la posizione ufficiale italiana sul MoU non è reperibile (N1),
...
- **A favore del costo:** se Atene e Nicosia percepissero Roma come partner inaffidabile, il valore del ponte
  crollerebbe. Ma questa percezione **non è documentata** dal lato greco-cipriota (N1): il "costo dell'ambiguità"
  è asserito, non provato.

## Cosa NON raccomando più (correzione v1)
La v1 raccomandava di "scegliere il tavolo energetico". L'adversary ha ragione: scegliere **ridurrebbe** la leva
italiana, non l'aumenterebbe — sacrificando o l'energia cipriota o la presa su Tripoli/migrazione. La
raccomandazione corretta è **gestire il ponte**, non abbandonarlo.

## Implicazioni per l'interesse nazionale italiano
1. La posizione a cavallo è un **asset negoziale** se attivamente valorizzata (offrire mediazione tra EMGF e
   Ankara), un rischio se subita passivamente.
2. Serve una linea *dichiarata* sulla legalità delle ZEE (ancoraggio UNCLOS) che non richieda però la rottura
   con Ankara sul dossier libico — un equilibrio difficile ma coerente.
3. Il metro di successo non è la "coerenza" tra i tavoli, ma la **capacità di monetizzare la centralità** su
   entrambi.

## Gap di conoscenza
- Posizione ufficiale italiana sul MoU turco-libico 2019: **non reperita** (N1).
- Percezione greco-cipriota dell'affidabilità italiana: non documentata.
- Peso reale dell'Italia nei negoziati EMGF vs Francia/Grecia: non quantificato.
