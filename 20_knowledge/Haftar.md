...
tipo: "persona"
provenance:
  - "00_inbox/dataset_libia/dataset_web_libia (BBC Monitoring 2025-12-29, 2026-05-01; Atlantic Council 2025-10-03)"
---
...
- Ago 2025: promuove i figli **Saddam** (vice comandante in capo) e **Khaled** (capo di SM), consolidando
  il controllo dinastico; un terzo figlio, **Belgacem**, guida il Development and Reconstruction Fund (DRF). `[verificato: BBC Monitoring]`
- Emergono però **spaccature tra i figli** (Saddam vs Khaled/Belgacem) su un'iniziativa USA di unificazione —
  potenziale rischio per gli sforzi di riunificazione. `[verificato: BBC Monitoring/Libya Observer]`

## Attori esterni e riarmo [HIGH confidence]
