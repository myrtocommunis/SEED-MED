...
- Maggio 2025: Dbeibah "scioglie" unilateralmente il Deterrence Apparatus; il DA rifiuta, rivendicando la giurisdizione del PC. A est, l'LNA di [[Haftar]] controlla la Cirenaica. `[verificato: BBC Monitoring]`
- **18 lug 2026 — un nuovo claimant**: a **Ginevra** un forum politico proclama un "governo unificato" guidato da **Mustafa al-Majdoub**, avviando un processo **fuori dall'egida ONU** (comitato preparatorio di 60 figure, 20 per ciascuna delle 3 regioni storiche). L'**UNSMIL prende le distanze** ("nessun legame"); nessun
  riconoscimento libico o internazionale. Segnale che la frammentazione **genera nuovi pretendenti** invece di ridursi (cfr. lo stallo delle [[Elezioni]]). `[verificato: The Libya Observer]`

## Sintomi della crisi [HIGH confidence]
- **Svalutazione del dinaro -14,7%** (18 gen 2026, dollaro a 6,38 dinari), per divisione politica, calo dei ricavi petroliferi e assenza di bilancio unificato (cfr. [[Bilancio libico]]). `[verificato: BBC/CBL]`
